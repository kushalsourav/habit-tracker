...
const TextEditor = ({ colors, icons, openModal, setCloseModal, setData , habit, isEdit }) => {
    ...
    <Modal
      ...
      <div className="texteditor">
        ...
        <div className="texteditor-body">
          <textarea name="model-text" id="model-textarea" className="texteditor-body-input" cols="30" rows="10" placeholder="Add Text" value={habit.name}
          onChange={(e) => 
           { setData({type:"HABITS" ,dateCreate:habit.dateAdded, name: e.target.value, iconName:habit.icon ,color:habit.colorCode})
        ...
        <div className="texteditor-footer">
          ...
          <button className="texteditor-right texteditor-header-button" onClick={() =>{
             isEdit.edit ? updateHabits(isEdit.editId, habit, token, setData) : postHabits(habit, token,setData)
              setCloseModal()
          }} >save</button>
        </div>
