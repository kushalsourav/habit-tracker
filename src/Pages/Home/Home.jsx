  ...
  CustomEase.create("slantCurve", "0,0,1,1");
    useEffect(() => {
     ...
     tl.to(".home", {
      ...
      }).to(".home-header", { duration: 3, opacity:1 , x: 100 }).to(".bottle", {duration:3,opacity:1, y:425, ease:Elastic.easeOut}).to(".basket-ball", {duration:2,opacity:1,y:400,ease:Bounce.easeOut}).to(".book", {duration:0.5,y:410,opacity:1,ease:Linear.easeIn}).to(".alarm", {duration:0.5, opacity:1, y:410, ease:Power4.easeIn})
